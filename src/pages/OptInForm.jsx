        ...
        <main className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 pt-14 md:pt-18 px-4">
            <div className="max-w-5xl mx-auto py-10 grid lg:grid-cols-[1.1fr,1fr] gap-8 items-start">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-lg border border-gray-100 dark:border-gray-700 rounded-xl p-6">
                    ...
                    <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded text-xs text-gray-700 dark:text-gray-300">
                        <strong>For Twilio Compliance Review:</strong> This is an exact replica of the SMS opt-in form shown to authenticated users at <code className="bg-white dark:bg-gray-700 px-1 rounded">versiful.io/welcome</code>
                    </div>
                </div>
            </div>
        </main>
